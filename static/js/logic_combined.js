...
L.geoJSON(data, {
  style: function (feature) {
    return {
      ...
      opacity: 1,
      fillOpacity: 0.2,
      dashArray: '3', // Dashed line
      lineCap: 'butt', // Line cap style
      lineJoin: 'miter', // Line join style
      shadowColor: '#D4D9DA', // Grey border
      shadowBlur: 5, // Border blur
      shadowOffsetX: 1, // Border X offset
      shadowOffsetY: 1, // Border Y offset
    };
  }
...
alert("Failed to load plate boundaries data. Please try again later.");
});
